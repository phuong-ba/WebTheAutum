...
export default function BillProduct({ onAddProduct }) {
      ...
      render: (_, record) => (
        <Space size="middle">
          <button
            ...
            className="bg-amber-500 py-2 px-4 rounded cursor-pointer select-none text-center font-bold text-white hover:bg-amber-600 active:bg-cyan-800 shadow transition-colors"
          >
